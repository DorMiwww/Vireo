...
3. Internal refactor (temporary, side track — not a roadmap phase): `agents/REFACTOR_PLAN.md` — module-by-module file-splitting and dedup plan, test-first per phase, 8 phases not yet started. Pick up the first `[not started]` phase in that file when resuming this work.
